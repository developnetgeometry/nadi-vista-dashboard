...
const mockData = {
  entrepreneur: {
    ...
    upcomingEvents: [
      { name: "Startup Bootcamp", date: "2024-07-15", participants: 50 },
      { name: "Business Plan Workshop", date: "2024-07-20", participants: 30 },
      { name: "Investor Pitch Day", date: "2024-07-25", participants: 75 }
    ],
    recentEvents: [
      { name: "Marketing Fundamentals", date: "2024-07-05", participants: 45, status: "Completed" },
      { name: "Financial Planning", date: "2024-07-02", participants: 38, status: "Completed" }
    ]
  },
  awareness: {
    totalEvents: 28,
    ...
    upcomingEvents: [
      { name: "Digital Literacy Workshop", date: "2024-07-18", participants: 40 },
      { name: "Cybersecurity Seminar", date: "2024-07-22", participants: 60 }
    ],
    recentEvents: [
      { name: "Tech Awareness Campaign", date: "2024-07-03", participants: 55, status: "Completed" },
      { name: "Digital Skills Training", date: "2024-07-01", participants: 42, status: "Completed" }
    ]
  },
  "lifelong-learning": {
    totalEvents: 35,
    ...
    upcomingEvents: [
      { name: "Professional Development Course", date: "2024-07-16", participants: 65 },
      { name: "Skills Certification Program", date: "2024-07-19", participants: 45 },
      { name: "Leadership Training", date: "2024-07-24", participants: 35 }
    ],
    recentEvents: [
      { name: "Communication Skills Workshop", date: "2024-07-04", participants: 52, status: "Completed" },
      { name: "Project Management Training", date: "2024-06-30", participants: 48, status: "Completed" }
    ]
  }
}
        ...
        <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {currentData.upcomingEvents.map((event: any, index: number) => (
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {currentData.recentEvents.map((event: any, index: number) => (
                    <div key={index} className="flex items-center justify-between p-3 border rounded-lg">
                      <div>
                        <h4 className="font-medium">{event.name}</h4>
                        <p className="text-sm text-muted-foreground">{event.date}</p>
