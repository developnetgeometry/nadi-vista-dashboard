...
const navigationItems = [
  {
    title: "Admin Console",
    items: [
      { title: "Home", url: "/tp/home", icon: Home },
      { title: "Membership", url: "/tp/membership", icon: Users },
      { title: "Smart Services", url: "/tp/smart-services", icon: Cpu },
      { title: "Operation", url: "/tp/operation", icon: Settings },
      { title: "Takwim", url: "/tp/takwim", icon: Calendar },
      { title: "Claim", url: "/tp/claim", icon: FileText }
    ]
  },
  {
    title: "Site Management",
    items: [
      { title: "Finance Management", url: "/tp/finance", icon: DollarSign }
    ]
  },
  {
...
export function AppSidebar() {
  ...
  try {
    ...
    console.error("TPSidebar: Router context not available", error)
  }
